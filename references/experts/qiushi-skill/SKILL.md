...
| 错误 | 问题 | 正确做法 |
|------|------|---------|
| 不调查就给出答案 | 缺乏事实依据 | 先调查，后发言 |
| 只看文档不看实际 | 脱离一线 | 深入一线获取第一手资料 |
| 调查走马观花 | 浮于表面 | 深入细致，不浮于表面 |
| 先有结论再找证据 |  confirmation bias | 从事实出发得出结论 |
| 只调查现状不看历史 | 缺少背景 | 历史与现状并重 |
| 只看一方面 | 信息偏差 | 多角度了解 |
